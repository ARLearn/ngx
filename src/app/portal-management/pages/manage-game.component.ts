      ...
      <div class="game-details">
        <div class="d-flex">
          <div class="form-info">
            ...
            <div class="form-group">
              <label class="form-label">Toegang gebruikers</label>
              <div>
                <mat-slide-toggle color="primary">Inloggen is vereist</mat-slide-toggle>
              </div>
            </div>
          </div>
          ...
          <div class="form-drag-drop">
            ...
            <div>
              <app-file-drop-zone [isOpen]="true"></app-file-drop-zone>
            </div>
